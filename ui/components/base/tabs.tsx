...
function Tabs({
  ...
  color = "brand",
  ...props
}: TabsPrimitive.Root.Props & { color?: "brand" | "neutral" }) {
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[color=neutral]/tabs:data-active:text-foreground group-data-[color=brand]/tabs:data-active:text-primary dark:group-data-[color=neutral]/tabs:data-active:text-foreground dark:group-data-[color=brand]/tabs:data-active:text-primary",
        ...
        "group-data-[color=neutral]/tabs:after:bg-foreground group-data-[color=brand]/tabs:after:bg-primary",
        className
      )}
      {...props}
    />
